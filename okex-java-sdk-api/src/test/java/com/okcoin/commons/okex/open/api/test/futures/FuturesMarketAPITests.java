...
public class FuturesMarketAPITests extends FuturesAPIBaseTests {
    ...
    public void testGetInstrumentBook() {
        Book book = marketAPIService.getInstrumentBook("BTC-USD-191227", "10","1");
    ...
    public void testGetInstrumentTicker() {
        Ticker ticker = marketAPIService.getInstrumentTicker("BTC-USD-191227");
    ...
    public void testGetInstrumentTrades() {
        List<Trades> trades = marketAPIService.getInstrumentTrades("BTC-USD-191227", null, null, null);
...
//        String end = "2019-07-15T03:15:00.000Z";
        JSONArray array = marketAPIService.getInstrumentCandles("EOS-USD-191227",
                                                                        "2019-11-26T09:01:00.000Z",
                                                                         "2019-11-26T09:05:00.000Z",
                                                                             "300");
    ...
    public void testGetInstrumentIndex() {
        Index index = marketAPIService.getInstrumentIndex("BTC-USD-191227");
    ...
    public void testGetInstrumentEstimatedPrice() {
        EstimatedPrice estimatedPrice = marketAPIService.getInstrumentEstimatedPrice("BTC-USD-191227");
    ...
    public void testGetInstrumentHolds() {
        Holds holds = marketAPIService.getInstrumentHolds("BTC-USD-191227");
    ...
    public void testGetInstrumentPriceLimit() {
        PriceLimit priceLimit = marketAPIService.getInstrumentPriceLimit("BTC-USD-191227");
    ...
    public void testGetMarkPrice() {
        JSONObject jsonObject = marketAPIService.getMarkPrice("BTC-USD-191227");
    ...
    public void testGetInstrumentLiquidation() {
        List<Liquidation> liquidations = marketAPIService.getInstrumentLiquidation("BTC-USD-191227", "1", "", "", "2");
    ...
    public void testGetHolds() {
        Holds holds = marketAPIService.getHolds("BTC-USD-191227");
        toResultString(LOG, "Instrument-Holds", holds);
    }
}
